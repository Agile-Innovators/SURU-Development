                        ...
                        <div className='relative'>
                            ...
                            {/* <div className="absolute h-40 w-40 bottom-[-40px] left-1/2 transform -translate-x-1/2 sm:left-10 sm:translate-x-0 sm:w-32 md:w-36 lg:w-40 rounded-full overflow-hidden border-4 border-white"> */}
                                <img
                                    ...
                                    alt="Foto de perfil"
                                    className="absolute object-cover h-40 w-40 bottom-[-40px] left-1/2 transform -translate-x-1/2 sm:left-10 sm:translate-x-0  rounded-full overflow-hidden border-4 border-white"
                                />
                            {/* </div> */}
