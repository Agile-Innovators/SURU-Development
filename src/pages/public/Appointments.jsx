...
export function Appointments() {
  ...
  const upcomingAppointments = [
    { name: 'Mario López', date: '25/09/2024', hour: '11:00 am', location: 'San Ramón' },
    { name: 'Lucía Martínez', date: '28/09/2024', hour: '12:30 pm', location: 'Palmares' },
  ];
  ...
  const [currentAppointments, setCurrentAppointments] = useState(activeAppointments);
  ...
  return (
    <div className="max-w-7xl m-auto p-4">
      ...
      <Table columns={columns} data={currentAppointments} actions={actions} />
    </div>
  );
}
