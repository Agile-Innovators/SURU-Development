...
export function LoginForm(){
    return (
        <section className="m-auto">
            <h1>Welcome Back</h1>
            <p className="text-grey">Sign in by entering the information below</p>

            <div className="grid gap-4 my-4">
                <Input type="text" label="Username" inputName="username" inputId="username" labelText="Username" spanText="Example: john@gmail.com" />
            ...
            <RedirectButton text="Sign In" href="/login" variant="fill" customClass="w-full"/>
        </section>
    );
}
