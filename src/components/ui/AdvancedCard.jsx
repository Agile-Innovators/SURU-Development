    ...
    return (
        <div className='rounded-md overflow-hidden border border-light-grey'>
            <div className='overflow-hidden relative'>
                ...
                <img className='w-full object-cover aspect-video' src={srcImage} alt={title} />
            </div>
            <section className='p-4'>
                ...
                <ul className='flex gap-2 py-1 my-2'> 
                     <li className='flex items-center px-1 border-r-[1px] pr-2 border-grey'><BedDouble size={22} strokeWidth={1} className='mr-2 text-secondary'/>{qtyBedrooms}</li>
                     <li className='flex items-center px-1 border-r-[1px] pr-2 border-grey'><Bath size={22} strokeWidth={1} className='mr-2 text-secondary'/>{qtyBathrooms}</li>
                     <li className='flex items-center px-1 border-r-[1px] pr-2 border-grey'><Car size={22} strokeWidth={1} className='mr-2 text-secondary'/>{qtyGarages}</li>
