...
export function BasicCard({children, src, title, text, customClass = ""}){
    ...
    return(
        <div className={`flex flex-col items-center text-center p-8 gap-3 w-fit border border-light-grey rounded-md transition-all duration-300 hover:shadow-md ${customClass}`}>
